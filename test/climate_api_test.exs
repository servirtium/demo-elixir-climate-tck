defmodule ClimateAPITest do
  ...
  describe "Servirtium pass through record mode" do
    ...
    # test "average Egyptian rainfall" do
    #   Plug.Cowboy.http(Plug.Servirtium.Playback, filename: "test/interactions/rainfall_1980_1999_egy.md",
    #     port: 34569
    #   )
    ...
    # test "no data available for Great Britain from 1985 to 1995" do
    #   Plug.Cowboy.http(Plug.Servirtium.Playback, filename: "test/interactions/rainfall_1985_1995_gbr.md",
    #     port: 34570
    #   )
    ...
    # test "Error Middle Earth isn't a real place" do
    #   Plug.Cowboy.http(Plug.Servirtium.Playback, filename: "test/interactions/rainfall_1980_1999_mde.md",
    #     port: 34571
    #   )
